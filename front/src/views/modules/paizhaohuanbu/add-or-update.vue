    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="申请类型" prop="paizhaohuanbuTypes">
                        <el-select v-model="ruleForm.paizhaohuanbuTypes" :disabled="ro.paizhaohuanbuTypes" placeholder="请选择申请类型">
                            <el-option
                                v-for="(item,index) in paizhaohuanbuTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="申请类型" prop="paizhaohuanbuValue">
                        <el-input v-model="ruleForm.paizhaohuanbuValue"
                            placeholder="申请类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="牌照" prop="paizhaohuanbuPaizhao">
                       <el-input v-model="ruleForm.paizhaohuanbuPaizhao"
                                 placeholder="牌照" clearable  :readonly="ro.paizhaohuanbuPaizhao"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="牌照" prop="paizhaohuanbuPaizhao">
                           <el-input v-model="ruleForm.paizhaohuanbuPaizhao"
                                     placeholder="牌照" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.paizhaohuanbuYesnoTypes" label="申请状态" prop="paizhaohuanbuYesnoTypes">
                        <el-input v-model="ruleForm.paizhaohuanbuYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.paizhaohuanbuYesnoText" label="申请结果" prop="paizhaohuanbuYesnoText">
                        <span v-html="ruleForm.paizhaohuanbuYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    cheliangId: false,
                    yonghuId: false,
                    paizhaohuanbuTypes: false,
                    paizhaohuanbuPaizhao: false,
                    paizhaohuanbuYesnoTypes: false,
                    paizhaohuanbuYesnoText: false,
                },
                ruleForm: {
                    cheliangId: '',
                    yonghuId: '',
                    paizhaohuanbuTypes: '',
                    paizhaohuanbuPaizhao: '',
                    paizhaohuanbuYesnoTypes: '',
                    paizhaohuanbuYesnoText: '',
                },
                paizhaohuanbuTypesOptions : [],
                paizhaohuanbuYesnoTypesOptions : [],
                cheliangOptions : [],
                yonghuOptions : [],
                rules: {
                   cheliangId: [
                   ...
                   paizhaohuanbuPaizhao: [
                              { required: true, message: '牌照不能为空', trigger: 'blur' },
                          ],
                   paizhaohuanbuYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=paizhaohuanbu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.paizhaohuanbuTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=paizhaohuanbu_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.paizhaohuanbuYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`paizhaohuanbu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.paizhaohuanbuCrossAddOrUpdateFlag = false;
                                        this.parent.search();

    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="申请牌照类型" prop="paizhaoshenqingTypes">
                        <el-select v-model="ruleForm.paizhaoshenqingTypes" :disabled="ro.paizhaoshenqingTypes" placeholder="请选择申请牌照类型">
                            <el-option
                                v-for="(item,index) in paizhaoshenqingTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="申请牌照类型" prop="paizhaoshenqingValue">
                        <el-input v-model="ruleForm.paizhaoshenqingValue"
                            placeholder="申请牌照类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="申请牌照" prop="paizhaoshenqingPaizhao">
                       <el-input v-model="ruleForm.paizhaoshenqingPaizhao"
                                 placeholder="申请牌照" clearable  :readonly="ro.paizhaoshenqingPaizhao"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="申请牌照" prop="paizhaoshenqingPaizhao">
                           <el-input v-model="ruleForm.paizhaoshenqingPaizhao"
                                     placeholder="申请牌照" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.paizhaoshenqingYesnoTypes" label="申请状态" prop="paizhaoshenqingYesnoTypes">
                        <el-input v-model="ruleForm.paizhaoshenqingYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.paizhaoshenqingYesnoText" label="申请结果" prop="paizhaoshenqingYesnoText">
                        <span v-html="ruleForm.paizhaoshenqingYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    cheliangId: false,
                    yonghuId: false,
                    paizhaoshenqingTypes: false,
                    paizhaoshenqingPaizhao: false,
                    paizhaoshenqingYesnoTypes: false,
                    paizhaoshenqingYesnoText: false,
                },
                ruleForm: {
                    cheliangId: '',
                    yonghuId: '',
                    paizhaoshenqingTypes: '',
                    paizhaoshenqingPaizhao: '',
                    paizhaoshenqingYesnoTypes: '',
                    paizhaoshenqingYesnoText: '',
                },
                paizhaoshenqingTypesOptions : [],
                paizhaoshenqingYesnoTypesOptions : [],
                cheliangOptions : [],
                yonghuOptions : [],
                rules: {
                   cheliangId: [
                   ...
                   paizhaoshenqingTypes: [
                              { required: true, message: '申请牌照类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   paizhaoshenqingPaizhao: [
                              { required: true, message: '申请牌照不能为空', trigger: 'blur' },
                          ],
                   paizhaoshenqingYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=paizhaoshenqing_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.paizhaoshenqingTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=paizhaoshenqing_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.paizhaoshenqingYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`paizhaoshenqing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.paizhaoshenqingCrossAddOrUpdateFlag = false;
                                        this.parent.search();

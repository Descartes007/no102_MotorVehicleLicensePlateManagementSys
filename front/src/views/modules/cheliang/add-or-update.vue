        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <div v-if="type=='info'" >
                        <el-form-item class="input" label="牌照类型" prop="paizhaoValue">
                        <el-input v-model="ruleForm.paizhaoValue"
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   paizhaoTypes: [
                              { required: true, message: '牌照类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=paizhao_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.paizhaoTypesOptions = data.data.list;
                    }
                });

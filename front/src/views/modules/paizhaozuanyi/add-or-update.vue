    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="转移用户名称" prop="paizhaozuanyiName">
                       <el-input v-model="ruleForm.paizhaozuanyiName"
                                 placeholder="转移用户名称" clearable  :readonly="ro.paizhaozuanyiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="转移用户名称" prop="paizhaozuanyiName">
                           <el-input v-model="ruleForm.paizhaozuanyiName"
                                     placeholder="转移用户名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="牌照" prop="paizhaozuanyiPaizhao">
                       <el-input v-model="ruleForm.paizhaozuanyiPaizhao"
                                 placeholder="牌照" clearable  :readonly="ro.paizhaozuanyiPaizhao"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="牌照" prop="paizhaozuanyiPaizhao">
                           <el-input v-model="ruleForm.paizhaozuanyiPaizhao"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.paizhaozuanyiYesnoTypes" label="申请状态" prop="paizhaozuanyiYesnoTypes">
                        <el-input v-model="ruleForm.paizhaozuanyiYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.paizhaozuanyiYesnoText" label="申请结果" prop="paizhaozuanyiYesnoText">
                        <span v-html="ruleForm.paizhaozuanyiYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    cheliangId: false,
                    yonghuId: false,
                    paizhaozuanyiName: false,
                    paizhaozuanyiPaizhao: false,
                    paizhaozuanyiYesnoTypes: false,
                    paizhaozuanyiYesnoText: false,
                },
                ruleForm: {
                    cheliangId: '',
                    yonghuId: '',
                    paizhaozuanyiName: '',
                    paizhaozuanyiPaizhao: '',
                    paizhaozuanyiYesnoTypes: '',
                    paizhaozuanyiYesnoText: '',
                },
                paizhaozuanyiYesnoTypesOptions : [],
                cheliangOptions : [],
                yonghuOptions : [],
                rules: {
                   cheliangId: [
                   ...
                   paizhaozuanyiName: [
                              { required: true, message: '转移用户名称不能为空', trigger: 'blur' },
                          ],
                   paizhaozuanyiPaizhao: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=paizhaozuanyi_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.paizhaozuanyiYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`paizhaozuanyi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.paizhaozuanyiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
